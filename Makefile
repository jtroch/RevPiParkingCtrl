...
_OBJ = jsoncpp.o piControlIf.o LedAnimation.o ThreadSynchronization.o HttpThread.o Authentication.o Settings.o IOHandler.o EntranceProcessing.o ExitProcessing.o Barrier.o CentralProcessing.o SiteStDenijsProcessing.o SiteZwijnaardeProcessing.o RevPiParkingCtrl.o 
